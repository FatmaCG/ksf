...
//   waitFor(5);  => waits for 5 second => Thread.sleep(5000)
  ...
  /*  public static String register() {
        ...
        driver.get(ConfigReader.getProperty("registerPage_url"));
        basePage.getRegisterPage().registerEmailBox.sendKeys(fakerEmail);
        basePage.getRegisterPage().registerPasswordBox.sendKeys(password);
        basePage.getRegisterPage().registerPasswordAgainBox.sendKeys(password + Keys.ENTER);
        ReusableMethods.waitForAlertIsPresent(5);
